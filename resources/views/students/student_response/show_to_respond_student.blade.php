...
@section('content')
    <div class="row">
        ...
        <div class="callout callout-info">
            ...
            <u><span class="text-info text-lg"><strong> {{ $requests_toStudents->request_from }}</strong></span></u>
            with the requested file <u><span class="text-success text-lg"><strong> {{ $requests_toStudents->document_name }}</strong></span></u>
            <a href="/show_requests_from_admins" type="button" class="btn btn-info bg-info float-right" style="text-decoration: none;">
                <i class="fa fa-arrow-left" style="padding: 10px;"></i> Return
            </a>
            <div class="modal-body">
                <form action="/respond_to_request_from_admins/{{ $requests_toStudents->id }}" enctype="multipart/form-data" method="POST" class="form-horizontal">
                    {{ csrf_field() }} 
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
