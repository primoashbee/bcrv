    ...
    <div class="row">
        ...
        <div class="callout callout-info">
            ...
            <div class="modal-body">
                <form action="/edit_request/{{ $requests->id }}" method="POST" class="form-horizontal">
                    {{ csrf_field() }} 
                    {{ method_field('PUT') }}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                        <input name="release_date" type="text" class="form-control datetimepicker-input" data-target="#reservationdatetime" value="{{ $requests->release_date }}" />
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="processing_officer" class="custom-select form-control-border" id="exampleSelectBorder">
                                        <option selected value="{{ $requests->processing_officer }}" selected>{{ $requests->processing_officer }}</option>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <option selected value="{{ $requests->status }}">{{ $requests->status }}</option>
