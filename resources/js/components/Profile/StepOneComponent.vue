<template>
    <div class="container ml-2">
        ...
        <div class="field">
            ...
            <div class="control">
                <input :class="['input form-control', ($v.form.username.$error) ? 'is-danger' : '']" type="text" placeholder="Text input"
        ...
        <div class="field">
            ...
            <div class="control">
                <input :class="['input form-control', ($v.form.demoEmail.$error) ? 'is-danger' : '']"  type="text" placeholder="Email input" v-model="form.demoEmail">
            </div>
